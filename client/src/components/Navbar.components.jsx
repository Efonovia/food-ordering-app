...
function Navbar() {
    const defaultClassName = "home page-template-default page page-id-21 wp-custom-logo theme-citadela woocommerce-js classic-theme-layout classic-header-layout default-theme-design page-fullwidth no-page-title no-header-space citadela-events-css pro-plugin-active sticky-header-enabled sticky-header-desktop-full sticky-header-mobile-full footer-collapsible-widgets-enabled custom-header custom-header-over-content custom-header-transparent-bg wide-content-width header-with-cart"
    const mobileDefault = "home page-template-default page page-id-21 wp-custom-logo theme-citadela woocommerce-js classic-theme-layout classic-header-layout default-theme-design page-fullwidth no-page-title no-header-space citadela-events-css pro-plugin-active sticky-header-enabled sticky-header-desktop-full sticky-header-mobile-full footer-collapsible-widgets-enabled custom-header custom-header-over-content custom-header-transparent-bg wide-content-width header-with-cart mobile-screen-width responsive-menu footer-collapsible-widgets"
    const mobileMenuOpened = "home page-template-default page page-id-21 wp-custom-logo theme-citadela woocommerce-js classic-theme-layout classic-header-layout default-theme-design page-fullwidth no-page-title no-header-space citadela-events-css pro-plugin-active sticky-header-enabled sticky-header-desktop-full sticky-header-mobile-full footer-collapsible-widgets-enabled custom-header custom-header-over-content custom-header-transparent-bg wide-content-width header-with-cart mobile-screen-width responsive-menu footer-collapsible-widgets menu-opened"
    const mobileCartOpened = "home page-template-default page page-id-21 wp-custom-logo theme-citadela woocommerce-js classic-theme-layout classic-header-layout default-theme-design page-fullwidth no-page-title no-header-space citadela-events-css pro-plugin-active sticky-header-enabled sticky-header-desktop-full sticky-header-mobile-full footer-collapsible-widgets-enabled custom-header custom-header-over-content custom-header-transparent-bg wide-content-width header-with-cart mobile-screen-width responsive-menu footer-collapsible-widgets cart-opened"

    const [isMobile, setIsMobile] = React.useState(window.innerWidth < 835)
    ...
    <header id="masthead" className="site-header logo-align-left-mobile" data-offset="120">
        <div className="grid-main">
            ...
            {!showMenu && <div className="site-branding hide-tagline-mobile" style={{maxWidth:"400px"}}>
                <div className="logo-wrapper" style={{maxWidth: "150px"}}
                    ...
                    <a href="index.html" className="custom-logo-link" rel="home" aria-current="page"><img width="66"
                ...
                <div className="text-logo">
                    ...
                    <p className="site-title"
                       ...
                       ><a href="index.html" rel="home">Citadela</a></p>
                </div>
            </div>}
                ...
                <div className="citadela-menu-container citadela-menu-main-menu">
                    ...
                    <ul id="main-menu" className="citadela-menu" data-liwidth="642">
                        {!isMobile && <><li id="menu-item-25"
                            ...
                            data-width="99"><a href="index.html" aria-current="page">Home</a>
                        </li>
                        <li id="menu-item-366"
                            ...
                            data-width="91"><a href="menu/index.html">Food</a>
                        </li>
                        <li id="menu-item-146"
                            ...
                            data-width="99"><a href="about/index.html">About</a>
                        </li>
                        <li id="menu-item-343"
                            ...
                            data-width="82"><a href="news/index.html">News</a></li>
                        <li id="menu-item-145"
                            className="menu-item menu-item-type-post_type menu-item-object-page menu-item-145 menu-item-position-4 top-level-menu-item"
                            data-width="102"><a href="contact/index.html">Contact</a></li></>}
                        {isMobile && <li className="menu-item-wrapper menu-item-has-children sub-menu-right-position top-level-menu-item">
                            ...
                            {showMenu && <ul className="sub-menu">
                                <li id="menu-item-25"
                                    ...
                                    data-width="99"><a href="index.html"
                                ...
                                <li id="menu-item-343"
                                    ...
                                    data-width="82"><a href="news/index.html">News</a></li>
                                <li id="menu-item-145"
                                    className="menu-item menu-item-type-post_type menu-item-object-page menu-item-145 menu-item-position-4 menu-item-cloned"
                                    data-width="102"><a href="contact/index.html">Contact</a>
                                </li>
                            </ul>}
                        </li>}
                    </ul>
