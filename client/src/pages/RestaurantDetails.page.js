        ...
        <main id="main" class="site-main">
            <article id="post-21" class="post-21 page type-page status-publish hentry">
                <div class="entry-content">
                    <div class="wp-block-citadela-blocks-custom-container citadela-block-custom-container responsive-options size-wide bg-type-image inside-space-none bg-size-auto has-bg has-overlay"
                    ...
                    data-block-mobile-breakpoint="900">
                        ...
                        <div class="inner-holder">
                            ...
                            <h1 class="has-huge-font-size wp-block-heading"><strong>Quick &amp; fresh food </strong><br/><strong>in your
                                    favorite bistro</strong><span style={{color: '#f13f51'}} class="has-inline-color"><sup>?</sup></span></h1>
                            ...
                            <div class="wp-block-citadela-blocks-spacer citadela-block-spacer responsive-options"
                                ...
                                data-block-mobile-breakpoint="900">
                                <div class="inner-holder" style={{paddingTop: '200px'}}></div>
                            </div>

                            <h2 class="wp-block-heading has-huge-font-size">Our Menu</h2>
